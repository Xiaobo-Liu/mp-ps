function [p, s, usq_prec] = PS_exp_Pade_hsd(X, m, delta, Padetype)
% The mixed-precision paterson-stockmeyer algorithm which uses only double,
% single, and half precisions.

% The degree of the Pade approximant is specified by m, 
...
e = exp(1);
c_pade_coefficients = get_pade_coefficients(m, Padetype);
