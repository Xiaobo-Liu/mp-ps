function [s, m] = cosm_params_taylor_ap(A, varargin)
%COSM_PARAMS_TAYLOR_AP  Getting the scaling parameter s and approximant
% degree m from the arbitrary precision algorithm for the matrix cosine 
% using Taylor approximants.
%
%   This code requires the Advanpix Multiprecision Computing Toolbox (see
%   www.advanpix.com).
%
%   [...] = cosm_params_taylor_ap(...,'precision',DIGITS) specifies the number of digits to be
...
%
%   [...] = cosm_params_taylor_ap(...,'epsilon',EPSILON) specifies the tolerance to be
...
%   if A is of class 'mp'.
%
%   [...] = cosm_params_taylor_ap(...,'maxdegree',MAXDEGREE) specifies the maximum degree of
