function [s, m] = expm_params_taylor_mp(A, varargin)
%EXPM_PARAMS_TAYLOR_MP  Getting the scaling parameter s and 
...
%   www.advanpix.com).
%
%   [...] = expm_params_taylor_mp(...,'precision',DIGITS) specifies the number of digits to be
...
%
%   [...] = expm_params_taylor_mp(...,'epsilon',EPSILON) specifies the tolerance to be used to
...
%
%   [...] = expm_params_taylor_mp(...,'maxscaling',MAXSQRTM) specifies the maximum number of
%   matrix products allowed during the squaring phase. Default is 100.
%
%   [...] = expm_params_taylor_mp(...,'maxdegree',MAXDEGREE) specifies the maximum degree of
