function [A, n_mats] = cosm_testmats(k, n)
%COSM_TESTMATS   98 test matrices from ANYMATRIX matrix collection, 
%   including matrices from the matrices-mp-cosm collection at
%   https://github.com/Xiaobo-Liu/matrices-mp-cosm
%   that are square, nonnormal, and not causing overflow in computing cosA.
    ...
    case 04, sA='core/nilpot_triang'; A=anymatrix(sA,n); % sparse
    ...
    case 82, sA='mpcosm/kela98r4'; A=anymatrix(sA);
    case 83, sA='mpcosm/kuda10'; A=anymatrix(sA);
    case 84, sA='mpcosm/lara17r1'; A=anymatrix(sA);
    case 85, sA='mpcosm/lara17r2'; A=anymatrix(sA);
    case 86, sA='mpcosm/lara17r3'; A=anymatrix(sA);
    case 87, sA='mpcosm/lara17r4'; A=anymatrix(sA);
    case 88, sA='mpcosm/lara17r5'; A=anymatrix(sA);
    case 89, sA='mpcosm/lara17r6'; A=anymatrix(sA);
    case 90, sA='mpcosm/mopa03r1'; A=anymatrix(sA);
    case 91, sA='mpcosm/mopa03r2'; A=anymatrix(sA);
    case 92, sA='mpcosm/naha95'; A=anymatrix(sA);
    case 93, sA='mpcosm/pang85r1'; A=anymatrix(sA);
    case 94, sA='mpcosm/pang85r2'; A=anymatrix(sA);
    case 95, sA='mpcosm/pang85r3'; A=anymatrix(sA);
    case 96, sA='mpcosm/trem05'; A=anymatrix(sA);
    case 97, sA='mpcosm/ward77r1'; A=anymatrix(sA);
    case 98, sA='mpcosm/ward77r2'; A=anymatrix(sA); 
%   case 99, sA='mpcosm/kela98r3'; A=anymatrix(sA); % removed as A^2=0, trivial case;
    end
    A = full(A);
end