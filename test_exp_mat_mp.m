...
% save the data
dataname = sprintf('data/exp_mat_mp.mat');
...
exportgraphics(gca, '../figs/err-mat_n100_u64.eps', 'ContentType', 'vector');
...
exportgraphics(gca, '../figs/cmplxreduc-mat_n100_u64.eps', 'ContentType', 'vector');
